...
class LanguagePicker extends Component {
    ...
    render() {
        ...
        const renderOption = (option, selected, onSelect, index) => {
            return (
                <TouchableOpacity onPress={onSelect} key={index}
                                  style={{
                                      padding: 5,
                                      backgroundColor: selected ? Constants.Color.DirtyBackground : 'white',
        ...
        return (
            <View style={{backgroundColor: 'white', maxHeight: Constants.Dimension.ScreenHeight(0.5), width: Constants.Dimension.ScreenWidth(0.8)}}>
                <Text style={{
                    fontSize: 20,
                    fontWeight: 'bold',
