            ...
            <View style={shipping.layout}>
                <ScrollView>
                    <View style={shipping.cardContainer}>
                        <TouchableOpacity>
                            <Image source={require('../../../images/card-1.png')} style={shipping.bankImage} />
                        </TouchableOpacity>
                        <TouchableOpacity>
                            <Image source={require('../../../images/card-2.png')} style={shipping.bankImage} />
                        </TouchableOpacity>
                        <TouchableOpacity>
                            <Image source={require('../../../images/card-3.png')} style={shipping.bankImage} />
                        </TouchableOpacity>
                    </View>
