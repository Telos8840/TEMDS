                ...
                <AppIntro
                    ...
                    <View style={intro.slide}>
                        ...
                        <View level={-15} style={intro.imageView}>
                            <Image style={intro.image} source={require('../../../images/intro1.png')} />
                        </View>
                    ...
                    <View style={intro.slide}>
                        <View level={10} style={intro.imageView}>
                            <Image style={intro.image} source={require('../../../images/phone.png')} />
                        </View>
                    ...
                    <View style={intro.slide}>
                        <View level={-15} style={intro.imageView}>
                            <Image style={intro.image} source={require('../../../images/intro.png')} />
                        </View>
