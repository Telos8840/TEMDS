...
import order from "./myorders-style";
    ...
    render() {
        return (
            <View style={order.body}>
                <Toolbar name="My Order" noIcon={true}/>

                <ScrollView>
                    <View style={order.card}>
                        <View style={order.row}>
                            <Image style={order.image} source={require('../../../images/man-s2.png')} />
                        ...
                        <View style={order.statusIcons}>
                            <View style={order.icon}>
                                <View style={[order.circel, order.finish]} />
                                <Text style={order.iconLabel}>PLACED</Text>
                            </View>
                            <View style={order.icon}>
                                <View style={[order.circel, order.going]} />
                                <Text style={order.iconLabel}>DISPATCHED</Text>
                            </View>
                            <View style={order.icon}>
                                <View style={[order.circel]} />
                    ...
                    <View style={order.card}>
                        <View style={order.row}>
                            <Image style={order.image} source={require('../../../images/man-s1.png')} />
                    ...
                    <View style={order.card}>
                        <View style={order.row}>
                            <Image style={order.image} source={require('../../../images/man-s4.png')} />
